    ...
    return (
        <div className="flex w-full h-full flex-1 bg-white rounded-xl">
            <div className="w-full space-y-6 px-4 md:px-8 border-2 border-black/10 dark:border-gray-700 rounded-xl shadow bg-white/70 dark:bg-gray-800 flex flex-col pt-8">
                <div className="flex items-center justify-between w-full mb-8 relative">
                    ...
                    <div className="flex gap-2 ml-0 mt-[-12px] mr-[-12px]">
                        <Link
                            ...
                            className="inline-block px-4 py-2 bg-white dark:bg-gray-900 text-black dark:text-white border-2 border-black/10 dark:border-gray-700 rounded-xl shadow hover:bg-gray-100 dark:hover:bg-gray-800 transition no-underline font-semibold"
                        >
                            Edit
                        </Link>
                        <button
                ...
                <p className="text-base text-black dark:text-white mb-3 text-left">
                    {note.content}
                </p>
                <div className="flex flex-col gap-1 mt-2">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 text-left">
                        Last updated:{' '}
                        {new Date(note.updated_at + 'Z').toLocaleString(
                            'en-US',
                            {
                                timeZone: 'America/Los_Angeles',
                            }
